export const playAdjustments: Record<string, number> = {
  // Key format: ${firstActionKey}_${playfulnessKey}_${lovingKey}_${extrovertKey}_${relationshipLoveKey}_${frequencyKey}
  ...
  play_low_low_true_low_low: -0.1,
  play_low_low_true_low_medium: -0.2,
  play_low_low_true_low_max: -0.3,
  play_low_low_true_medium_low: 0,
  play_low_low_true_medium_medium: 0,
  play_low_low_true_medium_max: -0.1,
  play_low_low_true_max_low: 0.1,
  play_low_low_true_max_medium: 0,
  play_low_low_true_max_max: 0,

  play_low_high_true_low_low: 0,
  play_low_high_true_low_medium: -0.1,
  play_low_high_true_low_max: -0.2,
  play_low_high_true_medium_low: 0.1,
  play_low_high_true_medium_medium: 0,
  play_low_high_true_medium_max: -0.1,
  play_low_high_true_max_low: 0.2,
  play_low_high_true_max_medium: 0.1,
  play_low_high_true_max_max: 0,

  play_high_low_true_low_low: 0.1,
  play_high_low_true_low_medium: 0,
  play_high_low_true_low_max: -0.1,
  play_high_low_true_medium_low: 0.3,
  play_high_low_true_medium_medium: 0.2,
  play_high_low_true_medium_max: 0.1,
  play_high_low_true_max_low: 1,
  play_high_low_true_max_medium: 0.5,
  play_high_low_true_max_max: 0.25,

  play_high_high_true_low_low: 0.2,
  play_high_high_true_low_medium: 0.3,
  play_high_high_true_low_max: 0.4,
  play_high_high_true_medium_low: 0.5,
  play_high_high_true_medium_medium: 0.25,
  play_high_high_true_medium_max: 0.1,
  play_high_high_true_max_low: 1.5,
  play_high_high_true_max_medium: 0.75,
  play_high_high_true_max_max: 0.3,

  // Add more keys for combinations with extroverted = false

  play_low_low_false_low_low: -0.3,
  play_low_low_false_low_medium: -0.75,
  play_low_low_false_low_max: -1.5,
  play_low_low_false_medium_low: -0.2,
  play_low_low_false_medium_medium: -0.5,
  play_low_low_false_medium_max: -1,
  play_low_low_false_max_low: -0.1,
  play_low_low_false_max_medium: -0.3,
  play_low_low_false_max_max: -0.5,

  play_low_high_false_low_low: -0.1,
  play_low_high_false_low_medium: -0.2,
  play_low_high_false_low_max: -0.3,
  play_low_high_false_medium_low: 0,
  play_low_high_false_medium_medium: -0.1,
  play_low_high_false_medium_max: -0.2,
  play_low_high_false_max_low: 1,
  play_low_high_false_max_medium: 0.5,
  play_low_high_false_max_max: 0.1,

  play_high_low_false_low_low: -0.2,
  play_high_low_false_low_medium: -0.3,
  play_high_low_false_low_max: -0.4,
  play_high_low_false_medium_low: 0,
  play_high_low_false_medium_medium: -0.2,
  play_high_low_false_medium_max: -0.3,
  play_high_low_false_max_low: 0.2,
  play_high_low_false_max_medium: 0,
  play_high_low_false_max_max: -0.2,

  play_high_high_false_low_low: 0,
  play_high_high_false_low_medium: -0.1,
  play_high_high_false_low_max: -0.2,
  play_high_high_false_medium_low: 1,
  play_high_high_false_medium_medium: 0.5,
  play_high_high_false_medium_max: 0,
  play_high_high_false_max_low: 2,
  play_high_high_false_max_medium: 1,
  play_high_high_false_max_max: 0.5,
};
